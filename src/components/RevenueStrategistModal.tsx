...
import { labelStyle, inputStyle, selectStyle, optionStyle, fieldPairGrid, modalCloseButtonStyle } from "./modalFormStyles";

export default function RevenueStrategistModal({ onClose }: { onClose: () => void }) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const result = await fetch("/api/contact", {
      ...
      body: JSON.stringify({
        ...
        interest: "Revenue Engineering Strategist Review",
        formId: "revenue_strategist_review",
        message,
      }),
          ...
          {step === 1 ? (
            <>
              ...
              <h2 style={{ fontFamily: "var(--font-burford-black), sans-serif", fontSize: "clamp(22px, 3vw, 32px)", fontWeight: 400, textTransform: "uppercase", letterSpacing: "0.04em", color: "#FFFFFF", lineHeight: 1.15, marginBottom: 8 }}>
                Request Your Free Revenue Engineering Review
              </h2>
              <p style={{ fontFamily: "var(--font-montserrat), sans-serif", fontSize: 14, color: "rgba(255,255,255,0.65)", lineHeight: 1.7, marginBottom: 28, maxWidth: 480 }}>
                Tell us a bit about your business and goals, and we&apos;ll follow up with a plain-English breakdown of where your CRM, automation, funnels, and reporting are leaking revenue.
              </p>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div style={{ marginBottom: 28 }}>
                  ...
                  <select value={form.goal} onChange={e => set("goal", e.target.value)} style={selectStyle}>
                    ...
                    <option style={optionStyle}>Automate Marketing Workflows</option>
                    <option style={optionStyle}>Clean Up &amp; Optimize Our CRM</option>
                    <option style={optionStyle}>Align Marketing &amp; Sales (RevOps)</option>
                    <option style={optionStyle}>Fix Funnel Drop-Off</option>
                    <option style={optionStyle}>Get Clearer Reporting &amp; Attribution</option>
                ...
                <button type="submit" disabled={submitting} style={{
                  ...
                  {submitting ? "Submitting…" : "Talk to a Strategist →"}
                </button>
              </form>
            </>
          ) : (
            <div style={{ textAlign: "center", padding: "20px 0 10px" }}>
              ...
              <p style={{ fontFamily: "var(--font-montserrat), sans-serif", fontSize: 15, color: "rgba(255,255,255,0.75)", lineHeight: 1.75, maxWidth: 420, margin: "0 auto 32px" }}>
                We&apos;ll review <strong style={{ color: "#d87307" }}>{form.company || "your business"}</strong> and follow up within 1–2 business days to talk through your revenue system.
              </p>
