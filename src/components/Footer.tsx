      ...
      <div style={{ background: "#F5F0E8", padding: "28px 32px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", textAlign: "left" }}>
          <p style={{
            ...
            Forging Brands. Driving Revenue<span style={{ position: "relative", display: "inline-block", width: 0 }}><span style={{ position: "absolute", fontSize: "0.42em", fontWeight: 700, top: "-1.55em", left: "0.05em" }}>™</span></span>.
          </p>
          <p style={{
