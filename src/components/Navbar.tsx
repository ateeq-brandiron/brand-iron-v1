...
export default function Navbar() {
  ...
  return (
    <nav style={{
      ...
      borderBottom: scrolled ? "1px solid rgba(216,115,7,0.2)" : "none",
      ...
      {/* Mobile menu */}
      {open && (
        <div style={{ background: "rgba(10,6,2,0.98)", borderTop: "1px solid rgba(216,115,7,0.2)", padding: "20px 32px 28px" }}>
          {navLinks.map(l => (
