...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    images: [
      ...
      "/images/case-studies/canvas-communities/canvas-communities-deck-cover.jpg",
      "/images/case-studies/canvas-communities/canvas-communities-deck-timeline.jpg",
      "/images/case-studies/canvas-communities/canvas-communities-deck-why-this-makes-sense.jpg",
    ...
    cardHoverImage: "/images/case-studies/canvas-communities/canvas-communities-deck-cover.jpg",
  ...
  {
    slug: "market-structure-edge",
    category: "revenue-growth",
    client: "Market Structure EDGE",
    title: "Market Structure EDGE",
    excerpt: "Market Structure EDGE partnered with Brand Iron to build the brand and go-to-market engine behind a new trading analytics platform, driving rapid growth in revenue, site traffic, and paid subscribers.",
    thumbnail: "/images/client-logos/market-structure-edge-logo.png",
    thumbnailAlt: "Market Structure EDGE logo, a bracket mark beside the stacked wordmark Market Structure Edge",
    images: [
    ...
    challenge: "Market Structure EDGE was introducing a new type of trading analytics experience to the market. The company needed to do more than explain how the platform worked — it needed to build a recognizable brand, educate prospective users, support trial adoption, and convert interest into paid subscriptions. That required a connected approach across brand development, customer education, digital acquisition, and ongoing engagement.",
    challengeLinks: [
      { text: "build a recognizable brand", href: "/blog/rebranding-agency-transforms-your-business/" },
      { text: "convert interest into paid subscriptions", href: "/blog/death-of-the-mql/" },
    ],
    solution: "Brand Iron worked in tandem with the Market Structure EDGE team to build a brand that reflected the platform's forward-thinking, high-tech positioning, then supported it with a connected go-to-market strategy spanning strategic partnerships, content and social media development, digital advertising, PR campaigns, and marketing automation. A dedicated automation campaign nurtured and educated prospects throughout the platform's 14-day free trial, creating a clearer path from awareness to trial to paid conversion.",
    solutionLinks: [
      { text: "connected go-to-market strategy", href: "/services/gtm/" },
      { text: "marketing automation", href: "/blog/revenue-automation-framework/" },
    ],
    deliverables: [
      { title: "Brand Development", description: "Brand Iron helped develop a brand identity and market presence aligned with the sophistication and innovation of the Market Structure EDGE platform." },
      { title: "Digital Advertising", description: "Multi-channel digital advertising helped attract new prospective customers and drive traffic to the platform." },
      { title: "Content & Social Media", description: "Brand Iron supported content and social media development to educate the market, communicate the product's value, and maintain engagement with prospective users." },
      { title: "PR & Strategic Partnerships", description: "PR campaigns and strategic partnerships expanded awareness and helped introduce the platform to a broader trading audience." },
      { title: "Marketing Automation", description: "Brand Iron developed a marketing automation campaign that nurtured and educated prospective customers throughout the 14-day free trial, giving Market Structure EDGE a structured way to keep prospects engaged as they learned the platform and moved toward becoming paid subscribers." },
    ],
    glanceTitle: "Results at a Glance",
    glance: [
      { title: "Revenue", description: "+228%" },
      { title: "Site Visitors", description: "+365%" },
      { title: "Paid Subscribers", description: "More Than 4x" },
      { title: "Measurement Period", description: "Q4 2020 to Q1 2021" },
      { title: "Trial Journey", description: "14-Day Free Trial" },
    ],
    results: [
      { value: "228%", label: "Increase in Revenue" },
      { value: "365%", label: "Increase in Site Visitors" },
      { value: "4x+", label: "Paid Subscribers" },
      { value: "14-Day", label: "Free Trial Journey" },
    ],
    closingTitle: "Turning a Complex Product Into a Scalable Growth Story",
    closingNote: "Market Structure EDGE had an innovative product, but innovation alone wasn't enough to create growth. The platform needed a brand that matched the sophistication of the technology, marketing that could attract the right users, and a customer journey that could educate prospects and move them toward conversion. By connecting brand development with digital acquisition, content, PR, partnerships, and marketing automation, Brand Iron helped Market Structure EDGE build a stronger foundation for taking its SaaS platform to market. According to the original case study materials, the result was measurable growth in traffic, subscribers, and revenue — a 228% increase in revenue and a 365% increase in site visitors from Q4 2020 to Q1 2021, with paid subscribers more than quadrupling in a single quarter.",
  },
  {
    slug: "modern-ir",
    category: "revenue-growth",
    client: "ModernIR",
    title: "ModernIR",
    excerpt: "ModernIR partnered with Brand Iron to define its differentiators and refresh its brand and marketing platform, repositioning a strong market structure analytics product for greater traction.",
    thumbnail: "/images/client-logos/modern-ir-logo.png",
    thumbnailAlt: "ModernIR logo, a checkmark-in-a-box mark beside the wordmark ModernIR in navy and green",
    images: [
      "/images/case-studies/modern-ir/modern-ir-hero.jpg",
      "/images/case-studies/modern-ir/modern-ir-closer-look-1.jpg",
      "/images/case-studies/modern-ir/modern-ir-closer-look-2.jpg",
    ...
    solution: "Brand Iron focused first on defining the value ModernIR brought to the market and identifying the differentiators that could separate the company from competing solutions. From there, the brand was refreshed to create a more consistent visual system across the company's website, sales materials, and marketing communications — one designed to make ModernIR feel more established, credible, and recognizable while keeping the focus on the value of its market structure analytics products. The refreshed brand was then supported through strategic marketing execution designed to help ModernIR target ideal customers more effectively.",
    solutionLinks: [
      { text: "the brand was refreshed", href: "/blog/rebranding-agency-transforms-your-business/" },
      { text: "strategic marketing execution", href: "/services/gtm/" },
    ],
    deliverables: [
      { title: "Brand Positioning", description: "Brand Iron helped ModernIR clarify the differentiators that defined its product offering and provided a stronger foundation for communicating value to prospective customers." },
      { title: "Brand Identity Refresh", description: "The visual identity was updated to create a more consistent, recognizable, and professional look and feel across the ModernIR brand." },
      { title: "Logo Evolution", description: "Brand Iron refreshed the ModernIR logo as part of the broader brand update, creating an identity better suited to the company's positioning and software offering." },
      { title: "Website & Digital Presence", description: "The updated brand was carried into ModernIR's digital presence, creating greater consistency between the company's products, messaging, and online experience." },
      { title: "Marketing & Sales Materials", description: "Brand Iron developed supporting materials designed to communicate ModernIR's capabilities more clearly and reinforce the new brand across customer-facing touchpoints." },
      { title: "Strategic Marketing Execution", description: "With the refreshed brand in place, Brand Iron helped ModernIR execute marketing efforts focused on awareness, credibility, and reaching the company's ideal customers." },
    ],
    glanceTitle: "Results at a Glance",
    glance: [
      { title: "New Clients & Software Sales", description: "+30%" },
      { title: "Performance vs. Original Goal", description: "3x" },
      { title: "Core Challenge", description: "Brand differentiation and market traction" },
      { title: "Brand Iron Support", description: "Positioning, Identity Refresh, Website, Marketing Materials & Strategic Execution" },
    ],
    results: [
      { value: "30%", label: "Increase in New Clients & Sales" },
      { value: "3x", label: "Original Growth Goal" },
    ],
    closingTitle: "Turning Product Strength Into Market Credibility",
    closingNote: "ModernIR already had a strong software product line. What it lacked was a brand and marketing platform capable of communicating that strength consistently. By defining the company's differentiators, refreshing its identity, and creating a more cohesive customer-facing presence, Brand Iron helped ModernIR build greater awareness and credibility in the market. According to the original case study materials, the engagement helped ModernIR grow new clients and software sales by 30% — 3x its original goal — demonstrating how stronger positioning and brand consistency can help a technically strong product become easier for prospective customers to understand, trust, and choose.",
  },
];
