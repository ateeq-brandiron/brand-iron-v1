    ...
    <main style={{ fontFamily: "var(--font-montserrat), sans-serif" }}>
      ...
      <section id="case-studies-grid" style={{ background: "#F9F8F6", padding: "100px 40px 120px" }}>
              ...
              return (
                ...
                >
                  ...
                  <div className="cs-card-media" style={{ position: "relative", aspectRatio: "4 / 3", overflow: "hidden", background: "#FFFFFF" }}>
                    ...
                    {hoverImage && (
                      // eslint-disable-next-line @next/next/no-img-element
                      <img src={hoverImage} alt={`${cs.client} website screenshot`} className="cs-card-hero" style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "contain", opacity: 0, transition: "opacity 0.4s ease" }} />
                    )}
        ...
        <style>{`
          ...
          .cs-card:hover .cs-card-hero { opacity: 1 !important; }
