      ...
      <section id="featured" style={{ background: "#F9F8F6", padding: "100px 40px" }}>
        <div ref={featuredViewRef} className={`reveal${featuredViewInView ? " visible" : ""}`} style={{ maxWidth: 1000, margin: "0 auto" }}>
          <div style={{
            ...
            <div className="res-featured-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 40, alignItems: "center" }}>
              <div className="res-featured-thumb-wrap" style={{ padding: "40px 0 40px 40px" }}>
              ...
              <div className="res-featured-text-wrap" style={{ padding: "40px 40px 40px 0" }}>
        ...
        <style>{`
          @media (max-width: 700px) {
            .res-featured-grid { grid-template-columns: 1fr !important; gap: 0 !important; }
            .res-featured-thumb-wrap, .res-featured-text-wrap { padding: 28px 24px !important; }
          }
        `}</style>
      </section>
