...
function ArticleMeta({ date, isGuide }: { date: string; isGuide?: boolean }) {
  return (
          ...
          <div className="blog-hero-grid" style={{ maxWidth: 1200, margin: "0 auto", width: "100%", display: "grid", gridTemplateColumns: "1.05fr 0.95fr", gap: 56, alignItems: "center" }}>
            ...
            <div className="hero-body-anim" style={{
              ...
              <p style={{ fontSize: "clamp(13px, 1.15vw, 15px)", lineHeight: 1.65, color: "rgba(255,255,255,0.85)" }}>
                Explore expert insights, industry trends, and practical strategies designed to help organizations become discoverable, trusted, and chosen. From AI visibility and go-to-market strategy to brand development and revenue engineering, our content is built to help leaders navigate change, identify opportunities, and drive measurable growth.
              </p>
            </div>
          </div>
        </div>
        ...
        <div ref={articlesViewRef} style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          {articles[0] && (
            ...
            >
              ...
              <ArticleMeta date={articles[0].date} isGuide={articles[0].isGuide} />
          ...
          <div className="blog-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 24 }}>
            {visibleArticles.map(({ slug, category, title, excerpt, readTime, date, isGuide }, i) => (
              ...
              >
                ...
                <ArticleMeta date={date} isGuide={isGuide} />
