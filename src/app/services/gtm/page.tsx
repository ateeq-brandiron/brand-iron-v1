...
function GrowthReviewModal({ onClose }: { onClose: () => void }) {
        ...
        <div style={{ padding: "36px 40px 40px" }}>
          {step === 1 ? (
            <>
              ...
              <p style={{ fontFamily: "'Montserrat', sans-serif", fontSize: 14, color: "rgba(255,255,255,0.65)", lineHeight: 1.7, marginBottom: 28, maxWidth: 480 }}>
              ...
              <form onSubmit={handleSubmit}>
                <div style={{ marginBottom: 14 }}>
                  <label style={gtmLabelStyle}>Name *</label>
                  <input required value={form.name} onChange={e => set("name", e.target.value)} style={gtmInputStyle} placeholder="Your name" />
                </div>
                <div style={{ marginBottom: 14 }}>
                  <label style={gtmLabelStyle}>Work Email *</label>
                  <input required type="email" value={form.email} onChange={e => set("email", e.target.value)} style={gtmInputStyle} placeholder="you@company.com" />
                </div>
                <div style={{ marginBottom: 14 }}>
                  <label style={gtmLabelStyle}>Company Name</label>
                  <input value={form.company} onChange={e => set("company", e.target.value)} style={gtmInputStyle} placeholder="Company" />
                </div>
                <div style={{ marginBottom: 14 }}>
                  <label style={gtmLabelStyle}>Website URL *</label>
                  <input required value={form.website} onChange={e => set("website", e.target.value)} style={gtmInputStyle} placeholder="https://yoursite.com" />
                </div>
                <div style={{ marginBottom: 28 }}>
                  <label style={gtmLabelStyle}>Primary Goal</label>
                  <select value={form.goal} onChange={e => set("goal", e.target.value)} style={gtmSelectStyle}>
                    <option value="" style={gtmOptionStyle}>Select one…</option>
                    <option style={gtmOptionStyle}>Increase Qualified Pipeline</option>
                    <option style={gtmOptionStyle}>Improve Brand Positioning &amp; Messaging</option>
                    <option style={gtmOptionStyle}>Launch a New Product or Market</option>
                    <option style={gtmOptionStyle}>Align Sales &amp; Marketing Systems</option>
                    <option style={gtmOptionStyle}>Not Sure — Need Strategic Guidance</option>
                  </select>
                </div>
...
const gtmLabelStyle: React.CSSProperties = {
  display: "block", fontFamily: "'Montserrat', sans-serif", fontSize: 11,
  fontWeight: 700, letterSpacing: "0.10em", textTransform: "uppercase",
  color: "rgba(255,255,255,0.55)", marginBottom: 6,
};
const gtmInputStyle: React.CSSProperties = {
...
const gtmSelectStyle: React.CSSProperties = {
  ...gtmInputStyle, appearance: "none" as const,
...
const gtmOptionStyle: React.CSSProperties = { background: "#FFFFFF", color: "#1a1a1a" };
