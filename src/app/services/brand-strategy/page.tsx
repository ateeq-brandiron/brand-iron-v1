  ...
  return (
    <main style={{ fontFamily: "var(--font-montserrat), sans-serif" }}>
      ...
      <section id="framework" style={{
        ...
        backgroundImage: "url('/images/Brand Iron Techy Hay Bale.png')",
      ...
      <section style={{ background: "#F0EEEA", padding: "80px 24px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div ref={ctaView.ref} className={`reveal${ctaView.inView ? ' visible' : ''}`} style={{
            ...
            backgroundImage: "url('/images/Brand Iron Tech River.png')", backgroundSize: "cover", backgroundPosition: "center",
          }}>
